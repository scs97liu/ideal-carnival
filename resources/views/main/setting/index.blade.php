                ...
                <div class="form-body">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <div class="input-group input-group-lg">
                                    <input type="number" min="0" step="0.1" class="form-control" name="high-target" value="{{ $user->getSetting('high_target', 8) }}">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                <div class="input-group input-group-lg">
                                    <input type="number" min="0" step="0.1" class="form-control" name="low-target" value="{{ $user->getSetting('low_target', 8) }}">
                                    <span class="input-group-addon" id="sizing-addon1">{{ $user->getSetting('preferred_units', 'mmol/l') }}</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <div class="form-group">
                                <select class="form-control input-lg" name="preferred-units">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <textarea name="notes" class="form-control" style="width:100%" rows="10">{!!  $user->getSetting('notes', null) !!}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
